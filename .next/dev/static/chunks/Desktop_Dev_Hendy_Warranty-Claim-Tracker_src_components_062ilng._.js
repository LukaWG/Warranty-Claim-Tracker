...
function SearchModal({ open, onClose }) {
    ...
    const { data: claims = [], isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Dev$2f$Hendy$2f$Warranty$2d$Claim$2d$Tracker$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "SearchModal.useQuery": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Dev$2f$Hendy$2f$Warranty$2d$Claim$2d$Tracker$2f$src$2f$api$2f$databaseClient$2e$js__$5b$client$5d$__$28$ecmascript$29$__["databaseClients"].WarrantyClaim.get()
            ...
            const applyPendingInfo = {
                "ApplyPendingUserInfo.useEffect.applyPendingInfo": async ()=>{
                    ...
                    try {
                        ...
                        const pendingInvites = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Dev$2f$Hendy$2f$Warranty$2d$Claim$2d$Tracker$2f$src$2f$api$2f$databaseClient$2e$js__$5b$client$5d$__$28$ecmascript$29$__["databaseClients"].PendingUserInvite.query('*', `email=${user.email}`);
...
_s(ApplyPendingUserInfo, "Sd/ke2td8CCwZaIXaDGjYa+CO44=", false, function() {
    return [
